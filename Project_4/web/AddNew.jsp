            ...
            <div class= "container">
                ...
                <div class ="col-sm-8 bg-light">
                    ...
                    <div class ="col-sm-12 bg-light">
                        <h1>Xin chào ${user.username} - Viết bài mới</h1>
                    </div>
                    <div class ="col-sm-12 bg-light">
                        <form action="addnew" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="shortDes" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="input topic">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Nội dung</label>
                                <textarea name="detailDes" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="inputState">Category</label>
                                <select name="cateid" id="inputState" class="form-control">
                                    <option selected value="1">Chân</option>
                                    <option value="2">Thiện</option>
                                    <option value="3">Mỹ</option>
                                </select>
                            </div>
                            <div class="form-check">
                                <input checked="" type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Đã xuất bản</label>
                            </div>
